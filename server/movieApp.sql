...
(
    ...
    name        VARCHAR(100) NOT NULL UNIQUE,                                  -- Name of the group
    owner_id    INT          NOT NULL REFERENCES users (id) ON DELETE CASCADE, -- Foreign key referencing the user who owns the group
